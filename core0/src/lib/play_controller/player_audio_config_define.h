...
typedef struct dmnr_send_cfg {
    ...
    int16_t             pow_xref_thld;              //-200~200(actual value*10)
    int16_t             ref_mask_thld;              //-200~200(actual value*10)
...
typedef struct mcra_send_cfg {
    ...
    int16_t             zeta_min;                   //-250~-50 (actual value*10)
    int16_t             zeta_max;                   //-200~-0 (actual value*10)
    int16_t             zeta_frame_min;             //-200~0 (actual value*10)
    int16_t             zeta_frame_max;             //-150~50 (actual value*10)
    int16_t             g_min;                      //-500~-100 (actual value*10)

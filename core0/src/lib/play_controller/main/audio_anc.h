...
#define AUDIO_DENOISE_ANC_MODE_CNT         10
#define AUDIO_DENOISE_TRANSPARENT_MODE_CNT 10

//suggested ANC scenarios
#define AUDIO_DENOISE_ANC_LIGHT         (AUDIO_DENOISE_ANC_START)
#define AUDIO_DENOISE_ANC_MIDDLE        (AUDIO_DENOISE_ANC_START + 1)
#define AUDIO_DENOISE_ANC_DEEP          (AUDIO_DENOISE_ANC_START + 2) //as well as commuting pattern
#define AUDIO_DENOISE_ANC_INDOOR        (AUDIO_DENOISE_ANC_START + 3)
#define AUDIO_DENOISE_ANC_OUTDOOR       (AUDIO_DENOISE_ANC_START + 4)
#define AUDIO_DENOISE_TRANSPARENT_FULL  (AUDIO_DENOISE_TRANSPARENT_START)
#define AUDIO_DENOISE_TRANSPARENT_VOICE (AUDIO_DENOISE_TRANSPARENT_START + 1)

typedef enum {
    AUDIO_DENOISE_PHYSICAL,
    AUDIO_DENOISE_ANC_START,
    AUDIO_DENOISE_ANC_END = AUDIO_DENOISE_ANC_START + AUDIO_DENOISE_ANC_MODE_CNT - 1,
    AUDIO_DENOISE_TRANSPARENT_START,
    AUDIO_DENOISE_TRANSPARENT_END = AUDIO_DENOISE_TRANSPARENT_START + AUDIO_DENOISE_TRANSPARENT_MODE_CNT - 1,
    AUDIO_DENOISE_MODE_MAX,//user can config anc mode and add physical mode.
} AUDIO_DENOISE_MODE;
...
typedef struct {
    ...
    uint8_t reserved[4];
    anc_coeff_idx_cfg coeff_cfg[AUDIO_DENOISE_ANC_MODE_CNT + AUDIO_DENOISE_TRANSPARENT_MODE_CNT];
